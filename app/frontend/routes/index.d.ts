 ...
 */
declare type Optional<T> = { [P in keyof T]?: T[P] | null };
...
declare type RequiredParameters<T extends number> =
  T extends 1 ? [RequiredRouteParameter]
  : T extends 2 ? [RequiredRouteParameter, RequiredRouteParameter]
  : T extends 3 ?
 ...
 * @returns {string} route path
 */
export const mission_control_jobs_path: ((options?: RouteOptions) => string) &
  RouteHelperExtras;
 ...
 * @returns {string} route path
 */
export const root_path: ((options?: RouteOptions) => string) &
  RouteHelperExtras;
